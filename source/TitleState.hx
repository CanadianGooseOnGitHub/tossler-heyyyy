...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		tosslertitle = new FlxSprite(-255, 0);
		tosslertitle.frames = Paths.getSparrowAtlas('titlescreen');
		tosslertitle.animation.addByPrefix('dance', 'TITLE SCREEN', false);
		tosslertitle.setGraphicSize(Std.int(tosslertitle.width * 0.75));
		add(tosslertitle);
	...
	override function beatHit()
	{
		...
		if(tosslertitle != null)
			tosslertitle.animation.play('dance');
